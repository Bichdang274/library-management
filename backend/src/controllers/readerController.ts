...
export const createReader = async (req: Request<{}, {}, CreateReaderBody>, res: Response) => {
    try {
...
export const updateReader = async (req: Request<{ id: string }, {}, Partial<CreateReaderBody>>, res: Response) => {
    try {
...
export const deleteReader = async (req: Request<{ id: string }>, res: Response) => {
    try {
